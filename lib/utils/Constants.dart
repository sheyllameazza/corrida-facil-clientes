...
// const DOMAIN_URL = ' 192.168.1.100:8000'; // Don't add slash at the end of the url
...
//walkthrough text
const walkthrough_title_1 = 'Buscar Motorista';
const walkthrough_subtitle_1 =
    ' "Solicite uma carona e aguarde por\num motorista nas proximidades"';
const walkthrough_image_1 = ic_walk1;

const walkthrough_title_2 = 'Selecione sua Corrida';
const walkthrough_subtitle_2 =
    "Solicite uma carona e aguarde por\num motorista nas proximidades";
const walkthrough_image_2 = ic_walk2;

const walkthrough_title_3 = 'Acompanhe sua Viagem';
const walkthrough_subtitle_3 =
    "Sua Viagem em tempo real com\nlocalização atual em tempo real no mapa";
